...
wb = openpyxl.load_workbook('Compiled Data Dictionary With NLP 12.15.16.xlsx')
sheet = wb.get_sheet_by_name('NLP_properties')
...
for row in range(2,n_rows):
    ...
    data_dict.sort()
#print data_dict
txtfile = open('variation_Syndrom_Prescursor_Control_Agent.txt', 'w')
